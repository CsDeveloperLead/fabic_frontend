    ...
    return (
        <>
            <div className='w-full h-auto flex justify-center'>
                <div className='w-[90%] h-auto border-[1px] border-[#1A3A37] mt-20 sm:mt-32 py-14 rounded-md px-5 sm:w-[60%] md:w-[40%] lg:w-[30%] xl:w-[25%]'>
                    <h1 className='text-center text-3xl font-semibold xl:text-4xl'><span className='text-[#1A3A37]'>Admin</span> Login</h1>
                    ...
                    <div className='w-full h-auto flex justify-center items-center '>
                        <span onClick={loginAdmin} className='px-8 py-1.5 text-white bg-[#1A3A37] rounded-md cursor-pointer font-semibold'>Login</span>
                    </div>
                </div>
            </div>
        </>
